...
trait Simulation[N <: SimulationNode] extends js.Object {
  ...
  def force(name: String, force: D3Force[N]): this.type = js.native
  def force(name: String): D3Force[N] = js.native
  ...
  // def on(typenames: String, listener: D3Listener0): this.type = js.native
  def on(typenames: String): this.type = js.native
}

trait D3Force[N <: SimulationNode] extends js.Object {
  def force(alpha: Double)
  def initialize(nodes: js.Array[N])
}

@js.native
trait D3ForceImplementation[N <: SimulationNode] extends D3Force[N] {
  def force(alpha: Double): Unit = js.native
  def initialize(nodes: js.Array[N]): Unit = js.native
}

@js.native
trait Centering[N <: SimulationNode] extends D3ForceImplementation[N] {
...
@js.native
trait PositioningX[N <: SimulationNode] extends D3ForceImplementation[N] {
  def x(x: Double): this.type = js.native
  def strength(strength: Double): this.type = js.native
}

@js.native
trait PositioningY[N <: SimulationNode] extends D3ForceImplementation[N] {
  def y(y: Double): this.type = js.native
  def strength(strength: Double): this.type = js.native
}

@js.native
trait ManyBody[N <: SimulationNode] extends D3ForceImplementation[N] {
  def strength(strength: Double): this.type = js.native
...
@js.native
trait Collision[N <: SimulationNode] extends D3ForceImplementation[N] {
  def radius(radius: js.Function1[N, Double]): this.type = js.native
  def strength(strength: Double): this.type = js.native
}

@js.native
trait Link[N <: SimulationNode, L <: SimulationLink[_ <: N, _ <: N]] extends D3ForceImplementation[N] {
